...
int main()
{
	...
	encoded_flag[0]  = operator_01<char_value<'?'>, 
		unsigned_char_value<0x10>>::result.value;

	encoded_flag[1]  = operator_01<char_value<'?'>, 
		unsigned_char_value<0x10>>::result.value;

	encoded_flag[2]  = operator_01<char_value<'?'>, 
		unsigned_char_value<0x10>>::result.value;

	encoded_flag[3]  = operator_01<char_value<'?'>, 
		unsigned_char_value<0x10>>::result.value;

	encoded_flag[4]  = operator_01<char_value<'?'>, 
		unsigned_char_value<0x10>>::result.value;

	encoded_flag[5]  = operator_02<char_value<'?'>, 
		unsigned_char_value<0x20>>::result.value;

	encoded_flag[6]  = operator_02<char_value<'?'>, 
		unsigned_char_value<0x20>>::result.value;

	encoded_flag[7]  = operator_02<char_value<'?'>, 
		unsigned_char_value<0x20>>::result.value;

	encoded_flag[8]  = operator_02<char_value<'?'>, 
		unsigned_char_value<0x20>>::result.value;

	encoded_flag[9]  = operator_02<char_value<'?'>, 
		unsigned_char_value<0x20>>::result.value;

	encoded_flag[10] = operator_03<char_value<'?'>, 
		unsigned_char_value<0x02>>::result.value;

	encoded_flag[11] = operator_03<char_value<'?'>, 
		unsigned_char_value<0x02>>::result.value;

	encoded_flag[12] = operator_03<char_value<'?'>, 
		unsigned_char_value<0x02>>::result.value;

	encoded_flag[13] = operator_03<char_value<'?'>, 
		unsigned_char_value<0x02>>::result.value;

	encoded_flag[14] = operator_03<char_value<'?'>, 
		unsigned_char_value<0x02>>::result.value;

	encoded_flag[15] = operator_04<char_value<'?'>, 
		unsigned_char_value<0xaa>>::result.value;

	encoded_flag[16] = operator_04<char_value<'?'>, 
		unsigned_char_value<0xaa>>::result.value;

	encoded_flag[17] = operator_04<char_value<'?'>, 
		unsigned_char_value<0xaa>>::result.value;

	encoded_flag[18] = operator_04<char_value<'?'>,
		unsigned_char_value<0xaa>>::result.value;
